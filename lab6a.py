...
class Student:
    ...
    def __init__(self, name, number):
        self.name = name
        self.number = str(number)  # Convert number to string to prevent errors
        self.courses = {}
    ...
    def displayGPA(self):
        if len(self.courses) == 0:  # Avoid division by zero
    ...
    # Return a list of courses where the student passed (grades > 0.0)
